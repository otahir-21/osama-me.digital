...
export const portfolioData: PortfolioProject[] = [
  {
    ...
    solution:
      "Architected and developed the full Flutter application for iOS and Android with livestreaming, real-time chat, creator profiles, subscription payments, and secure premium content access.",
    results: [
      "Launched cross-platform app for iOS & Android from a single Flutter codebase",
      "Real-time livestream + chat experience with strong engagement",
      "Creators able to monetize via in-app subscriptions and premium content",
    ],
    techStack: ["Flutter", "Dart", "REST APIs", "Realtime chat"],
