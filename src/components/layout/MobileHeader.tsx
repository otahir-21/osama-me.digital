...
export function MobileHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-zinc-800/80 bg-zinc-950/90 backdrop-blur-md lg:hidden">
      ...
      {open && (
        <nav className="border-t border-zinc-800/80 px-3 py-3">
